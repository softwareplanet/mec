...
let CardComponent = ({path, title, image, variant, size, rightMargin}) => {    
    const linkStyles = variant === 'grid' ? {width: `${size}px`, height: `${size}px`, marginBottom: "15px", marginRight: `${rightMargin}px` } : {};
    return (
